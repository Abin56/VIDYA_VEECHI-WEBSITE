                    ...
                    Row(
                      ...
                      children: [ 
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              Image.asset("assets/images/next-week.png",height: 20,),
                              const TextFontWidget(text: " Batch", fontsize: 14),
                            ],
                          )),
                      ...
                      children: [ 
                       SizedBox(
                          ...
                          width: 180,child: Row(
                            children: [
                              Image.asset("assets/images/next-week.png",height: 20,),
                              const TextFontWidget(text: " Total Class", fontsize: 14),
                            ],
                          )),
                      ...
                      children: [ 
                        SizedBox(
                          ...
                          width: 180,child: Row(
                            children: [
                              Image.asset("assets/images/next-week.png",height: 20,),
                              const TextFontWidget(text: " Total Students", fontsize: 14),
                            ],
                          )),
                      ...
                      children: [ 
                        SizedBox(
                          ...
                          width: 180,child: Row(
                            children: [
                              Image.asset("assets/images/next-week.png",height: 20,),
                              const TextFontWidget(text: " Total Staff", fontsize: 14),
                            ],
                          )),
                        const TextFontWidget(text: "20", fontsize: 14)
                      ],
                      ...
                      children: [ 
                        SizedBox(
                          ...
                          width: 180,child: Row(
                            children: [
                              Image.asset("assets/images/next-week.png",height: 20,),
                              const TextFontWidget(text: " Total Full A+", fontsize: 14),
                            ],
                          )),
