...
class ExamNotification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      ? Column(
        children: [ 
          const TextFontWidget(text: "Examinations", fontsize: 18,fontWeight: FontWeight.bold,),
         Padding(
             ...
             child: Container(
              width: double.infinity,
                   ...
                   decoration: const BoxDecoration(  color: cWhite,
                          border: Border(left: BorderSide(width: 0.2)),boxShadow: [BoxShadow(blurRadius: 1)]),
                    child: const Center(
                        child: Row(
                     ...
                     child: Container(
                      ...
                      child: const Center(
                        child: TextFontWidget(
                            text: "PUBLIC LEVEL EXAMS", fontsize: 16,fontWeight: FontWeight.w500,),
                      ),
                                   ),
                   ),
                 ),
                   ...
                   child: GestureDetector(
                    onTap: () {
                     ...
                     child: Container(
                      ...
                      child: const Center(
                        child: TextFontWidget(
                            text: "SCHOOL LEVEL EXAMS", fontsize: 16,fontWeight: FontWeight.w500,),
                      ),
                                   ),
                   ),
                 ),
      ...
      : Column(
        children: [
          const TextFontWidget(text: "Examinations", fontsize: 20,fontWeight: FontWeight.bold,),
          const Padding(
              ...
              Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        const TextFontWidget(
                            text: "SCHOOL LEVEL EXAMS", fontsize: 18,fontWeight: FontWeight.w500,),
                            const Padding(
              ...
              Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        const TextFontWidget(
                            text: "PUBLIC LEVEL EXAMS", fontsize: 18,fontWeight: FontWeight.w500,),
                             const Padding(
                              padding: EdgeInsets.only(top: 8,left: 10,right: 10),
                              child: Divider(),
                            ),
