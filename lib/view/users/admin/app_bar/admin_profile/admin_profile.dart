  ...
  final adminprofileListWidget = [
    ...
    Container(
        ...
        child: TextFontWidget(
            text: "Employee Id", fontsize: ResponsiveWebSite.isMobile(context)?12:14,)), //,,,,,,,,,...........2
    Container(
        height: 35,
        ...
        child:  Padding(
          ...
          child: TextFontWidget(text: "0256324", fontsize: ResponsiveWebSite.isMobile(context)?12:14,),
        )), //.......,..............................................3
    Container(
        height: 35,
        width: ResponsiveWebSite.isMobile(context)?100:120,
        alignment: Alignment.centerLeft,
        child:  TextFontWidget(
            text: "Gender", fontsize: ResponsiveWebSite.isMobile(context)?12:14,)), //.............4
    Container(
        height: 35,
        width: ResponsiveWebSite.isMobile(context)?170:220,
        decoration: BoxDecoration(
        ...
        child:  Padding(
          padding: EdgeInsets.all(4.0),
          child: TextFontWidget(text: "Male", fontsize: ResponsiveWebSite.isMobile(context)?12:14,overflow: TextOverflow.ellipsis,),
        )), //.................................5
    Container(
        height: 35,
        width: ResponsiveWebSite.isMobile(context)?100:120,
        alignment: Alignment.centerLeft,
        child: TextFontWidget(text: "Email", fontsize: ResponsiveWebSite.isMobile(context)?12:14,)), ///,,.......6
    Container(
        height: 35,
        width: ResponsiveWebSite.isMobile(context)?170:220,
        decoration: BoxDecoration(
        ...
        child: Padding(
          padding: EdgeInsets.all(4.0),
          child: TextFontWidget(text: "Principal@gmail.com", fontsize: ResponsiveWebSite.isMobile(context)?12:14,),
        )), //....................7
    Container(
        height: 35,
        width: ResponsiveWebSite.isMobile(context)?100:120,
        alignment: Alignment.centerLeft,
        child:  TextFontWidget(
            text: "Phone Number", fontsize: ResponsiveWebSite.isMobile(context)?12:14,)), //............8
    Container(
        height: 35,
        width: ResponsiveWebSite.isMobile(context)?170:220,
        decoration: BoxDecoration(
        ...
        child:  Padding(
          padding: EdgeInsets.all(4.0),
          child: TextFontWidget(text: "8089262564", fontsize: ResponsiveWebSite.isMobile(context)?12:14,),
        )), ///...................9
        Padding(
          padding:  EdgeInsets.only(left: ResponsiveWebSite.isMobile(context)?1:3,),
          child: Container(
            height: 35,
            width: 35,
            decoration: BoxDecoration(color:Color.fromARGB(255, 216, 232, 233),
              borderRadius: BorderRadius.circular(5)),
            
            child: Icon(Icons.edit,size: 15,color: Color.fromARGB(255, 3, 194, 9),),
          ),
        ),/////////////////////////////,,,,,,,Edit button..................10
  ];
  aweSideSheet(
